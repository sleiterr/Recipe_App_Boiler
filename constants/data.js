...
export const RECIPES = [
  {
    ...
    description:
      "En let og frisk bowl med perfekt stegt laks, knasende grøntsager og en syrlig middelhavsdressing. Perfekt til en hurtig frokost eller let aftensmad.",
    ingredients: [
      "200g Laks",
      "1/2 Quinoa",
      "Cherrytomater",
  ...
  },
  {
    ...
    description:
      "Varmende og cremet græskarsuppe med et kick af frisk ingefær. Serveret med ristede græskarkerner for det perfekte knas.",
    ingredients: [
      "1 Hokkaido Græskar",
      "Frisk Ingefær (3cm)",
      "1 Løg & 2 Fed Hvidløg",
  ...
  },
  {
    ...
    description:
      "Saftig kylling med sprød krydderurtpanering og frisk citronsauce. Perfekt til hverdagsmiddage.",
    ingredients: [
      "2 Kyllingebryster",
  ...
  },
  {
    ...
    description:
      "Farverig bowl med krydrede kikærter, avocado og quinoa — mættende og nærende.",
    ingredients: [
      "200g Kikærter",
      "1 Avocado",
      "1/2 Quinoa",
  ...
  },
  {
    ...
    categories: ["Quick"],
    description:
      "Lækker spaghetti med saftige rejer, hvidløg og et strejf af chili — enkel og velsmagende.",
    ingredients: [
      "200g Spaghetti",
      "200g Rejer",
      "3 Fed Hvidløg",
  ...
  },
  {
    ...
    categories: ["Easy Prep"],
    description:
      "Silkeagtig og sund chokolademousse lavet på avocado — dessert uden skyld.",
    ingredients: [
      "2 Modne Avocadoer",
      "3 spsk Kakao",
      "2 spsk Ahornsirup",
